...
public class TC079_Display_error_msg {
	...
	@Test     // UNF_079 - To verify whether application displays error message upon entering invalid details while creating product based on the category
	public void validLoginTest() throws InterruptedException {
        ...
        System.out.println("Successfully able to add new Category");
	}
	@AfterTest
	public void AddProduct() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//i[@class='fa fa-save']")).click();
        driver.findElement(By.xpath("//i[@class='fa fa-check-circle']")).isDisplayed();
        System.out.println("Successfully able to add new Product");
        //driver.close();  
	}
}